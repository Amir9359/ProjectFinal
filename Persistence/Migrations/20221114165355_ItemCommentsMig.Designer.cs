...
namespace Persistence.Migrations
{
    ...
    [Migration("20221114165355_ItemCommentsMig")]
    partial class ItemCommentsMig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Catalogs.CatalogItems.CatalogItemComments.CatalogItemComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 146, DateTimeKind.Local).AddTicks(9216));
            ...
            modelBuilder.Entity("Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 167, DateTimeKind.Local).AddTicks(8127));
            ...
            modelBuilder.Entity("Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 168, DateTimeKind.Local).AddTicks(2433));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 168, DateTimeKind.Local).AddTicks(6469));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 169, DateTimeKind.Local).AddTicks(1123));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemFavourite", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 169, DateTimeKind.Local).AddTicks(8233));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 170, DateTimeKind.Local).AddTicks(4869));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 170, DateTimeKind.Local).AddTicks(9662));
            ...
            modelBuilder.Entity("Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 171, DateTimeKind.Local).AddTicks(3319));
            ...
            modelBuilder.Entity("Domain.Discounts.Discount", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 171, DateTimeKind.Local).AddTicks(8514));
                    ...
                    b.Property<bool>("RequieredCoponeCode")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 172, DateTimeKind.Local).AddTicks(5186));
            ...
            modelBuilder.Entity("Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 173, DateTimeKind.Local).AddTicks(1983));
            ...
            modelBuilder.Entity("Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 173, DateTimeKind.Local).AddTicks(6045));
            ...
            modelBuilder.Entity("Domain.Users.UserAddress", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 11, 14, 20, 23, 54, 173, DateTimeKind.Local).AddTicks(9358));
                    ...
                    b.OwnsOne("Domain.Orders.Address", "Address", b1 =>
                        {
                            ...
                            b1.Property<string>("PostalAddres")
                                .HasColumnType("nvarchar(max)");
