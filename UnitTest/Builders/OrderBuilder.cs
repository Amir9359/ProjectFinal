...
namespace UnitTest.Builders
{
    public class OrderBuilder
    {
        ...
        public string TestProductName => "test productName";
        ...
        public Order CreateOrderWithDefaultValues()
        {
            ...
            return new Order(TestBuyerId, new AddressBuilder().Build(), testOrderItem, Address.PaymentMethod.OnlinePaymnt, null);
        }
    }
}